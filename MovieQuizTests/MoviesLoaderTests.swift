...
class MoviesLoaderTests: XCTestCase {
    struct StubNetworkClient: NetworkRouting {
        ...
        let emulateError: Bool // заглушка эмулировала либо ошибку сети, либо успешный ответ
    ...
    func testSuccessLoading() throws { // проверка успешной загрузки
        // Given
        let stubNetworkClient = StubNetworkClient(emulateError: false) // не эмулировать ошибку
    ...
    func testFailureLoading() throws { // проверка ошибки
        // Given
